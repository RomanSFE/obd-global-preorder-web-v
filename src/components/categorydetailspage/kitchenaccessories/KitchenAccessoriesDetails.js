...
export default class KitchenAccessoriesDetails extends Component {
    render() {
        return (
            <>
                                        ...
                                        <div className="obd-category-details-section-product-snnggl-itm">
                                            <Link to="/#">
                                                <div className="obd-category-details-section-product-snnggl-itm-img">
                                                    <img src={require('../../../assets/more-all-products-4.png')} alt="orponbd online shop"/>
                                                </div>
